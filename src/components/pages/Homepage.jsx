...
function Homepage() {
    return (
        <div className='md:w-full relative bg-neutral-100'>
            ...
            <div className="text-neutral-800 lg:text-5xl md:text-3xl text-xl absolute md:left-[32%] left-[26%] text-center md:mt-[60px] py-9 font-bold">Find The Right Tasker</div>
        </div>
    )
}
