...
function Homepage() {
    return (
        <div className='md:w-full relative bg-neutral-100 z-[-1]'>
            <div className='block w-full h-[45vh]'>
            ...
            <div>
                <div className="flex justify-center items-center">
                    ...
                    <button className=" md:text-2xl sm:text-lg text-md font-light bg-emerald-600 h-16 text-white rounded-tr-[40px] md:w-[195px] w-[120px] rounded-br-[40px]"> Search </button>
                </div>
            </div>
        </div>
    )
