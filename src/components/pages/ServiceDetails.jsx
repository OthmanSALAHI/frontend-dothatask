...
function ServiceDetails() {
  return (
    <div className='relative bg-neutral-100 lg:m-[100px] md:m-[60px] '>
      <div className='w-full flex lg:flex-row flex-col items-center justify-center lg:gap-[50px] gap-[2px] m-[20px]'>
        <SliderImages />
          <ServiceProfile/>
      </div>
        <div className="w-[1330px] h-auto p-9 m-[20px] bg-white shadow flex-col justify-start items-start gap-10 inline-flex">
            <div className="text-neutral-800 text-2xl font-bold font-Ubuntu">About This Advertisement</div>
