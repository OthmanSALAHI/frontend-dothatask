  ...
  return (
    <div className="md:w-[650px] w-full md:h-[538px] h-auto p-14 pb-4 bg-white shadow flex-col justify-start items-start gap-10">
        ...
        <div className='flex flex-col gap-2.5 my-2'>
          ...
          <input type='text' value='123 Main Street, Anchorage, USA 12345' className="md:w-[490px] w-[130px] h-12 p-2.5 bg-white rounded-[5px] shadow justify-start items-center gap-[113px] inline-flex" />
        </div>
        <div className='flex flex-col gap-2.5 my-2'>
          <div className="text-neutral-600 text-base font-normal">City</div>
          <input type='text' value='Dakhla' className="md:w-[490px] w-[130px] h-12 p-2.5 bg-white rounded-[5px] shadow justify-start items-center gap-[113px] inline-flex" />
        </div>
