...
function Personalinfo() {
  return (
    <div className="w-[650px] h-[538px] p-14 bg-white shadow flex-col justify-start items-start gap-10">
        ...
        <button type='submit' className="w-[119px] h-[38px] my-5 p-2.5 mb-5 bg-do_green hover:bg-do_hover_green rounded-[5px] justify-center items-center gap-2.5 inline-flex">
