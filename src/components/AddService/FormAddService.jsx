    ...
    <div className='relative '>
        <div className='md:m-[120px] m-5 flex flex-col gap-8'>
            ...
            <form className='relative flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
                <input className=" md:w-[580px] w-[200px] h-8 p-6 text-do_gray_text_input text-xl font-normal " placeholder='Exemple: create a professionalbusiness logo design' />
                <div className="text-neutral-800 md:text-2xl text-md mt-5 font-medium">Category</div>
                <select {...register('categorie', { required: true })}  className=" md:w-[580px] w-[200px] h-14 text-xl p-2 font-normal outline-none text-do_gray_text_input">
                ...
                <div className="md:w-[580px] w-[200px] text-neutral-500 text-lg font-normal ">enterthe service description accurately that includes all information and conditions</div>
                <textarea type="comment" {...register('description', {required: true})} placeholder='i need ...' className='md:w-[580px] w-[200px] h-48 p-2 outline-none' />
                ...
                <div className="md:w-[580px] w-[200px] text-neutral-500 text-lg font-normal">Add well-designed pictures to show you service professionally and increase your sales.</div>
